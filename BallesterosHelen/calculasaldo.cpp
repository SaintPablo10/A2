...
{//Abrimos llave.
	float HABC_x,HABC_s=0;//Usamos float para representar un caracter y declaramos las variables flotantes.
	int HABC_i=0,HABC_l;//Usamos int para representar un caracter y declaramos las variables enteras.
	cout<<"Ingrese cantidad de egresos (l): ";cin>>HABC_l;//Usamos cout para mostar por pantalla cualquier dato y cin para que el usuario ingrese datos.
	cout<<"Ingrese saldo inicial (s): ";cin>>HABC_s;///Usamos cout para mostar por pantalla cualquier dato y cin para que el usuario ingrese datos.
	
	do{//Usamos do-while para repetir una instruccion hasta que la expresion especificada sea falsa.
	cout<<"Ingrese egreso(x): ";cin>>HABC_x;//Usamos cout para pedir un valor y cin para que el usuario lo ingrese
	...
	cout<<"El saldo final es: "<<HABC_s<<endl;//Usamos cout para mostrar un mensaje y usamos endl para un salto de linea.
